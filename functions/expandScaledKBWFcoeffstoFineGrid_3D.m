%======================================================================== %
% Y = expandScaledKBWFcoeffstoFineGrid_3D(Ck,scale,param,output_size)
%======================================================================== %
% DEFINITION
% This function re-expands the KBWF coefficients in the KBWF basis. 
%======================================================================== %
% INPUTS 
% Ck             Coefficients
% scale          Scale of the KBWF 
% param          KBWF information (a, m, alpha, etc.)
% output_size    Volume size at fine scale (s=1), i.e., ground-truth size.
%======================================================================== %
% OUTPUTS 
% Y              Re-expanded volume 
%======================================================================== %
...
% Fill the coarse grid to fine grid 
% I.e., fix the boundaries, refine the gaps in between
