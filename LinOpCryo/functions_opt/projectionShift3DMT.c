/*// g = projection3D(cK, r1,r2, Ti, Tp, LT, supp, shiftX, shiftY)
//
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    mexPrintf("inside the for loop, printing N: %d,%d,%d \n",N[0],N[1],N[2]);
    ...
    for (t=0 ; t<NTHREAD ; t++){
        ...
        mexPrintf("inside the for loop, printing N before: %d,%d,%d \n",N[0],N[1],N[2]);
        ...
        mexPrintf("inside the for loop, printing N: %d,%d,%d,%d \n",N[0],N[1],N[2],N[3]);
        mexPrintf("inside the for loop, printing N: %d,%d,%d, %d \n",(*data[t]).N[0],(*data[t]).N[1],(*data[t]).N[2],(*data[t]).N[6]);

        mexPrintf("inside the for loop, printing N: %d,%d \n",M[0],M[1]);
        mexPrintf("inside the for loop, printing N: %d,%d \n",(*data[t]).M[0],(*data[t]).M[1]);
